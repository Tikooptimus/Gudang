                ...
                <div class="card-body">
                    <div class="form-group form-label-group">
                        ...
                        <input type="text" name="name" class="form-control {{$errors->has('name')?'is-invalid':''}}"
                            value="{{old('name',$rc->name)}}" id="iName" placeholder="Name" required>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group form-label-group">
                        ...
                        <input type="email" name="email" class="form-control {{$errors->has('email')?'is-invalid':''}}"
                            value="{{old('email',$rc->email)}}" id="iEmail" placeholder="Email" required>
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group form-label-group">
                        ...
                        <input type="password" name="password"
                            class="form-control {{$errors->has('password')?'is-invalid':''}}" id="iPassword"
                    ...
                    <div class="form-group form-label-group">
                        ...
                        <input type="password" name="repassword"
                            class="form-control {{$errors->has('repassword')?'is-invalid':''}}" id="iRePassword"
